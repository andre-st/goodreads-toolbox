...
- Further software 
  - I leave stats about _your_ reading habits to the following products and other book sites; my toolbox is a) about the social periphery, with b) _Goodreads_ providing the largest user base now and probably in the near future due to network effects (60 Mio users is an advantage that cannot be easily copied by competitors as opposed to everything else)
