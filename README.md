...
- install [Docker for Mac](https://download.docker.com/mac/) or [Windows](https://download.docker.com/win/) (LCOW), copy this repository somewhere and run the ./Dockerfile
