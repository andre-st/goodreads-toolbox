...
- Further software 
  - I leave stats about _your_ reading habits to the following products and other book sites; my toolbox is a) about the social periphery, with b) _Goodreads_ providing the largest user base. I guess, this will not change in the foreseeable future as this advantage cannot be easily copied by competitors due to network effects (as opposed to the website's CRUD features)
