...
- **Grouping shelves** with a prefix, e.g., _"region-usa"_,
  ...
  - having pseudo sub-shelves _"computer-history"_, _"computer-networks"_ and so on, there is an extra _"computer"_ shelf with all books from the children shelves
