...
- we learn: book combinations tend to become unique quickly - combinations of same books are more rare than combinations of same authors, while latter still satisfies the 'same taste' condition (assumption with books is that likeminded people have the same exposure to the same books, but that's questionable - comparing the authors widens this)
